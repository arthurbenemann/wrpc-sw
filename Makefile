...
# cross compiler to produce programs to be run on ARM64 cpu on WRSv4
CROSS_COMPILE_TARGET_HOST-$(CONFIG_TARGET_WR_SWITCH_V4) ?= $(CROSS_COMPILE_ARM64)
...
LDS-$(CONFIG_TARGET_WR_SWITCH) = arch/risc-v/ram-wrs-v4.ld
