...
/* definitions for register: Holdover DAC Output */

/* definitions for field: DAC value in reg: Holdover DAC Output */
#define SPLL_DAC_HO_VALUE_MASK                WBGEN2_GEN_MASK(0, 16)
#define SPLL_DAC_HO_VALUE_SHIFT               0
#define SPLL_DAC_HO_VALUE_W(value)            WBGEN2_GEN_WRITE(value, 0, 16)
#define SPLL_DAC_HO_VALUE_R(reg)              WBGEN2_GEN_READ(reg, 0, 16)
...
/* definitions for register: Holdover Control Register */

/* definitions for field: Holdover active in reg: Holdover Control Register */
#define SPLL_HO_CR_HO_ACTIVE                  WBGEN2_GEN_MASK(0, 1)

/* definitions for field: Learning active in reg: Holdover Control Register */
#define SPLL_HO_CR_LRN_ACTIVE                 WBGEN2_GEN_MASK(4, 1)

/* definitions for field: Holdover function select in reg: Holdover Control Register */
#define SPLL_HO_CR_FUNC_SEL_MASK              WBGEN2_GEN_MASK(8, 4)
#define SPLL_HO_CR_FUNC_SEL_SHIFT             8
#define SPLL_HO_CR_FUNC_SEL_W(value)          WBGEN2_GEN_WRITE(value, 8, 4)
#define SPLL_HO_CR_FUNC_SEL_R(reg)            WBGEN2_GEN_READ(reg, 8, 4)

/* definitions for register: HO buffer sample rate register */
...
PACKED struct SPLL_WB {
  ...
  uint32_t DAC_MAIN;
  /* [0x48]: REG Holdover DAC Output */
  uint32_t DAC_HO;
  /* [0x4c]: REG DDMTD Deglitcher threshold */
  uint32_t DEGLITCH_THR;
  /* [0x50]: REG Debug FIFO Register - SPLL side */
  uint32_t DFR_SPLL;
  /* [0x54]: REG Holdover Control Register */
  uint32_t HO_CR;
  /* [0x58]: REG HO buffer sample rate register */
  uint32_t HO_RATE;
  /* padding to: 24 words */
