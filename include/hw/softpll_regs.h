/*
  ...
  * Created        : Fri Sep 14 13:25:32 2018
  * Standard       : ANSI C
...
/* definitions for register: Frequency Measurement */

/* definitions for field: FREQ in reg: Frequency Measurement */
#define SPLL_F_MEAS_VALUE_FREQ_MASK           WBGEN2_GEN_MASK(0, 28)
#define SPLL_F_MEAS_VALUE_FREQ_SHIFT          0
#define SPLL_F_MEAS_VALUE_FREQ_W(value)       WBGEN2_GEN_WRITE(value, 0, 28)
#define SPLL_F_MEAS_VALUE_FREQ_R(reg)         WBGEN2_GEN_READ(reg, 0, 28)

/* definitions for field: VALID in reg: Frequency Measurement */
#define SPLL_F_MEAS_VALUE_VALID               WBGEN2_GEN_MASK(28, 1)

/* definitions for register: Frequency Measurement Control Register */

/* definitions for field: Channel select in reg: Frequency Measurement Control Register */
#define SPLL_F_MEAS_CR_CHAN_SEL_MASK          WBGEN2_GEN_MASK(0, 4)
#define SPLL_F_MEAS_CR_CHAN_SEL_SHIFT         0
#define SPLL_F_MEAS_CR_CHAN_SEL_W(value)      WBGEN2_GEN_WRITE(value, 0, 4)
#define SPLL_F_MEAS_CR_CHAN_SEL_R(reg)        WBGEN2_GEN_READ(reg, 0, 4)

/* definitions for register: Placeholder */

/* definitions for field: PLACEHOLDER in reg: Placeholder */
#define SPLL_PLACEHOLDER0_PLACEHOLDER_MASK    WBGEN2_GEN_MASK(0, 28)
#define SPLL_PLACEHOLDER0_PLACEHOLDER_SHIFT   0
#define SPLL_PLACEHOLDER0_PLACEHOLDER_W(value) WBGEN2_GEN_WRITE(value, 0, 28)
#define SPLL_PLACEHOLDER0_PLACEHOLDER_R(reg)  WBGEN2_GEN_READ(reg, 0, 28)
...
uint32_t AL_CIN;
/* [0x14]: REG Frequency Measurement */
uint32_t F_MEAS_VALUE;
/* [0x18]: REG Frequency Measurement Control Register */
uint32_t F_MEAS_CR;
/* [0x1c]: REG Placeholder */
