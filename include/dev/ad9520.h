...
int ad9520_set_divider( struct ad9520_device *dev, int div_idx, int value );
int ad9520_sync_outputs( struct ad9520_device *dev );
int ad9520_enable_output( struct ad9520_device *dev, int enable );
